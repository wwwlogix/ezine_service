...
class pushmessage{ 
	...
	public $androidAuthKey		= "AIzaSyC-qabibx5TXAqMi5NtW96JaOQNlqycQ5Y";
	...
	//var_dump($params);
	//$message =  $registration_id."inside ANDROIDS <br>". $params['msg']['id']." <br>".$params['msg']['notification'];
	//return $message; 
       $this->androidAuthKey = "AIzaSyC-qabibx5TXAqMi5NtW96JaOQNlqycQ5Y";//Auth Key Herer
         
        ## data is different from what your app is programmed 
        $data = array( 
                'registration_ids' => array($registration_id), 
                'data' => array( 
                                'gcm_msg'	=>  $params['msg']['notification'],
								'id'		=>  $params['msg']['id'],
								'title' 	=>  $params['msg']['notification']
    ...
    private function sendMessageIos($registration_id, $params) {
		//$message = $registration_id."inside IOS". $params;
		//return $message;
		...
		/*$payload['aps'] = array('alert' => array("body"=>array( 
                                							'id'		=>  $params['msg']['id'],
															'title' 	=>  $params['msg']['notification']
															), "action-loc-key"=>"View"), 'badge' => 0, 'sound' => 'default');*/
		...
		$payload['extra_info'] = array('apns_msg' => 'hello IOS'); 
